...
Product Manager by day, builder by night.
Currently exploring the intersection of AI, autonomous agents, and platform engineering.
...
| Area | Tech |
|---|---|
| **AI & Development** | Python • Gemini API • Vertex AI • Streamlit |
| **Cloud & Infrastructure** | GCP • Terraform • Docker • Cloud Run • BigQuery |
| **Security & Governance** | Cloud Security • IAM • FinOps |
